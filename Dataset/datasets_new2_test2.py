...
class MyDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        Organ_mask = (Mask_Brainstem + Mask_Esophagus + Mask_Larynx + Mask_LeftParotid + Mask_Mandible +
             + Mask_RightParotid + Mask_SpinalCord)
             
        
        data_all = np.concatenate([dose, ct, PTVs_mask, Mask_possible_dose_mask, Organ_mask], axis=-1)
