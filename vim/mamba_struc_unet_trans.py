...
class SimpleTransformer(nn.Module):
    def __init__(self, channels, num_heads=8, num_layers=1, dropout=0.1):
        super().__init__()
...
class MambaUnet(nn.Module):
    def __init__(
        ...
        self.transformer = SimpleTransformer(channels=384)
    ...
    def forward(self, inp_img,structure, t):
        ...
        out_transformer = self.transformer(out_enc_level4)
        out_enc_level4 = out_transformer
        
        #print("out_transformer", out_transformer.shape)
